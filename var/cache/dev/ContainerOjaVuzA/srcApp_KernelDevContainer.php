...
class srcApp_KernelDevContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\DailyFridgeController' => 'getDailyFridgeControllerService',
    ...
    /*
     * Gets the public 'App\Controller\DailyFridgeController' shared autowired service.
     *
     * @return \App\Controller\DailyFridgeController
     */
    protected function getDailyFridgeControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\DailyFridgeController.php';

        $this->services['App\\Controller\\DailyFridgeController'] = $instance = new \App\Controller\DailyFridgeController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\DailyFridgeController', $this));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('foKTpREP14', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_GlobalClearerService()
    {
        ...
        return $this->services['cache.global_clearer'] = new \Symfony\Component\HttpKernel\CacheClearer\Psr6CacheClearer(['cache.app' => ($this->services['cache.app'] ?? $this->getCache_AppService()), 'cache.system' => ($this->services['cache.system'] ?? $this->getCache_SystemService()), 'cache.validator' => ($this->privates['cache.validator'] ?? $this->getCache_ValidatorService()), 'cache.serializer' => ($this->privates['cache.serializer'] ?? $this->getCache_SerializerService()), 'cache.annotations' => ($this->privates['cache.annotations'] ?? $this->getCache_AnnotationsService()), 'cache.property_info' => ($this->privates['cache.property_info'] ?? $this->getCache_PropertyInfoService()), 'cache.property_access' => ($this->privates['cache.property_access'] ?? $this->getCache_PropertyAccessService()), 'cache.doctrine.orm.default.metadata' => ($this->privates['cache.doctrine.orm.default.metadata'] ?? ($this->privates['cache.doctrine.orm.default.metadata'] = new \Symfony\Component\Cache\Adapter\ArrayAdapter())), 'cache.doctrine.orm.default.result' => ($this->privates['cache.doctrine.orm.default.result'] ?? ($this->privates['cache.doctrine.orm.default.result'] = new \Symfony\Component\Cache\Adapter\ArrayAdapter())), 'cache.doctrine.orm.default.query' => ($this->privates['cache.doctrine.orm.default.query'] ?? ($this->privates['cache.doctrine.orm.default.query'] = new \Symfony\Component\Cache\Adapter\ArrayAdapter())), 'cache.security_expression_language' => ($this->privates['cache.security_expression_language'] ?? $this->getCache_SecurityExpressionLanguageService()), 'cache.webpack_encore' => ($this->privates['cache.webpack_encore'] ?? $this->getCache_WebpackEncoreService())]);
    }
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sqyaqR6c-k', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getCache_SystemClearerService()
    {
        ...
        return $this->services['cache.system_clearer'] = new \Symfony\Component\HttpKernel\CacheClearer\Psr6CacheClearer(['cache.system' => ($this->services['cache.system'] ?? $this->getCache_SystemService()), 'cache.validator' => ($this->privates['cache.validator'] ?? $this->getCache_ValidatorService()), 'cache.serializer' => ($this->privates['cache.serializer'] ?? $this->getCache_SerializerService()), 'cache.annotations' => ($this->privates['cache.annotations'] ?? $this->getCache_AnnotationsService()), 'cache.property_info' => ($this->privates['cache.property_info'] ?? $this->getCache_PropertyInfoService()), 'cache.property_access' => ($this->privates['cache.property_access'] ?? $this->getCache_PropertyAccessService()), 'cache.security_expression_language' => ($this->privates['cache.security_expression_language'] ?? $this->getCache_SecurityExpressionLanguageService()), 'cache.webpack_encore' => ($this->privates['cache.webpack_encore'] ?? $this->getCache_WebpackEncoreService())]);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        }, 8), false, ($this->targetDir.''.'/srcApp_KernelDevContainerDeprecations.log'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\CompoRecetteRepository' => ['privates', 'App\\Repository\\CompoRecetteRepository', 'getCompoRecetteRepositoryService', false],
            'App\\Repository\\HistoriqueAchatRepository' => ['privates', 'App\\Repository\\HistoriqueAchatRepository', 'getHistoriqueAchatRepositoryService', false],
            'App\\Repository\\ProduitRepository' => ['privates', 'App\\Repository\\ProduitRepository', 'getProduitRepositoryService', false],
            'App\\Repository\\RecetteRepository' => ['privates', 'App\\Repository\\RecetteRepository', 'getRecetteRepositoryService', false],
            'App\\Repository\\TypeUtilisateurRepository' => ['privates', 'App\\Repository\\TypeUtilisateurRepository', 'getTypeUtilisateurRepositoryService', false],
            ...
            'App\\Repository\\TypeUtilisateurRepository' => '?',
    ...
    protected function getServicesResetterService()
    {
        ...
        }), ['cache.app' => [0 => 'reset'], 'cache.system' => [0 => 'reset'], 'cache.validator' => [0 => 'reset'], 'cache.serializer' => [0 => 'reset'], 'cache.annotations' => [0 => 'reset'], 'cache.property_info' => [0 => 'reset'], 'form.choice_list_factory.cached' => [0 => 'reset'], 'profiler' => [0 => 'reset'], 'debug.validator' => [0 => 'reset'], 'debug.stopwatch' => [0 => 'reset'], 'doctrine' => [0 => 'reset'], 'form.type.entity' => [0 => 'reset'], 'security.token_storage' => [0 => 'disableUsageTracking', 1 => 'setToken'], 'cache.security_expression_language' => [0 => 'reset'], 'monolog.handler.main' => [0 => 'reset'], 'monolog.handler.console' => [0 => 'reset'], 'webpack_encore.tag_renderer' => [0 => 'reset'], 'cache.webpack_encore' => [0 => 'reset'], 'webpack_encore.entrypoint_lookup[_default]' => [0 => 'reset'], 'swiftmailer.email_sender.listener' => [0 => 'reset']]);
    }
    ...
    /*
     * Gets the private '.service_locator.A9FiRqy' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_A9FiRqyService()
    {
        return $this->privates['.service_locator.A9FiRqy'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'em' => ['services', 'doctrine.orm.default_entity_manager', 'getDoctrine_Orm_DefaultEntityManagerService', false],
            'historepo' => ['privates', 'App\\Repository\\HistoriqueAchatRepository', 'getHistoriqueAchatRepositoryService', false],
        ], [
            'em' => '?',
            'historepo' => 'App\\Repository\\HistoriqueAchatRepository',
        ]);
    }

    /*
     * Gets the private '.service_locator.PjNDzse' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_PjNDzseService()
    {
        return $this->privates['.service_locator.PjNDzse'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    /*
     * Gets the private '.service_locator.cPhdqWx' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_CPhdqWxService()
    {
        return $this->privates['.service_locator.cPhdqWx'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'HistoriqueAchat' => ['privates', 'App\\Repository\\HistoriqueAchatRepository', 'getHistoriqueAchatRepositoryService', false],
            'em' => ['services', 'doctrine.orm.default_entity_manager', 'getDoctrine_Orm_DefaultEntityManagerService', false],
            'paginator' => ['services', 'knp_paginator', 'getKnpPaginatorService', false],
            'produit' => ['privates', 'App\\Repository\\ProduitRepository', 'getProduitRepositoryService', false],
        ], [
            'HistoriqueAchat' => 'App\\Repository\\HistoriqueAchatRepository',
            'em' => '?',
            'paginator' => '?',
    ...
    /*
     * Gets the private '.service_locator.gPOL4mW' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_GPOL4mWService()
    {
        return $this->privates['.service_locator.gPOL4mW'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'manager' => ['services', 'doctrine.orm.default_entity_manager', 'getDoctrine_Orm_DefaultEntityManagerService', false],
        ], [
            'manager' => '?',
        ]);
    ...
    /*
     * Gets the private '.service_locator.kS4J_tF' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_KS4JTFService()
    {
        return $this->privates['.service_locator.kS4J_tF'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'HistoriqueAchat' => ['privates', 'App\\Repository\\HistoriqueAchatRepository', 'getHistoriqueAchatRepositoryService', false],
        ], [
            'HistoriqueAchat' => 'App\\Repository\\HistoriqueAchatRepository',
        ]);
    ...
    /*
     * Gets the private '.service_locator.nLcoaOg' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_NLcoaOgService()
    {
        return $this->privates['.service_locator.nLcoaOg'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'em' => ['services', 'doctrine.orm.default_entity_manager', 'getDoctrine_Orm_DefaultEntityManagerService', false],
            'paginator' => ['services', 'knp_paginator', 'getKnpPaginatorService', false],
        ], [
            'em' => '?',
    ...
    /*
     * Gets the private '.service_locator.z8PBJKF' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Z8PBJKFService()
    {
        return $this->privates['.service_locator.z8PBJKF'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'HistoriqueAchat' => ['privates', 'App\\Repository\\HistoriqueAchatRepository', 'getHistoriqueAchatRepositoryService', false],
            'paginator' => ['services', 'knp_paginator', 'getKnpPaginatorService', false],
        ], [
            'HistoriqueAchat' => 'App\\Repository\\HistoriqueAchatRepository',
    ...
    /*
     * Gets the private 'App\Repository\CompoRecetteRepository' shared autowired service.
     *
     * @return \App\Repository\CompoRecetteRepository
     */
    protected function getCompoRecetteRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\CompoRecetteRepository.php';

        return $this->privates['App\\Repository\\CompoRecetteRepository'] = new \App\Repository\CompoRecetteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /*
     * Gets the private 'App\Repository\HistoriqueAchatRepository' shared autowired service.
     *
     * @return \App\Repository\HistoriqueAchatRepository
     */
    protected function getHistoriqueAchatRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\persistence\\lib\\Doctrine\\Persistence\\ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\collections\\lib\\Doctrine\\Common\\Collections\\Selectable.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\orm\\lib\\Doctrine\\ORM\\EntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\HistoriqueAchatRepository.php';

        return $this->privates['App\\Repository\\HistoriqueAchatRepository'] = new \App\Repository\HistoriqueAchatRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
     ...
     */
    protected function getRecetteRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\persistence\\lib\\Doctrine\\Persistence\\ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\collections\\lib\\Doctrine\\Common\\Collections\\Selectable.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\orm\\lib\\Doctrine\\ORM\\EntityRepository.php';
    ...
    /*
     * Gets the private 'App\Repository\TypeUtilisateurRepository' shared autowired service.
     *
     * @return \App\Repository\TypeUtilisateurRepository
     */
    protected function getTypeUtilisateurRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\persistence\\lib\\Doctrine\\Persistence\\ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\collections\\lib\\Doctrine\\Common\\Collections\\Selectable.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\orm\\lib\\Doctrine\\ORM\\EntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\doctrine-bundle\\Repository\\ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\TypeUtilisateurRepository.php';

        return $this->privates['App\\Repository\\TypeUtilisateurRepository'] = new \App\Repository\TypeUtilisateurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    protected function getArgumentResolver_ServiceService()
    {
        ...
        return $this->privates['argument_resolver.service'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\ContactController::index' => ['privates', '.service_locator.8ZuNAXa', 'get_ServiceLocator_8ZuNAXaService', false],
            'App\\Controller\\DailyFridgeController::accueil' => ['privates', '.service_locator.kS4J_tF', 'get_ServiceLocator_KS4JTFService', false],
            'App\\Controller\\DailyFridgeController::frigo' => ['privates', '.service_locator.z8PBJKF', 'get_ServiceLocator_Z8PBJKFService', false],
            'App\\Controller\\DailyFridgeController::frigo_detail' => ['privates', '.service_locator.cPhdqWx', 'get_ServiceLocator_CPhdqWxService', false],
            'App\\Controller\\DailyFridgeController::index' => ['privates', '.service_locator.kS4J_tF', 'get_ServiceLocator_KS4JTFService', false],
            'App\\Controller\\DailyFridgeController::liste_produit' => ['privates', '.service_locator.nLcoaOg', 'get_ServiceLocator_NLcoaOgService', false],
            'App\\Controller\\DailyFridgeController::mes_produits_perimes' => ['privates', '.service_locator.nLcoaOg', 'get_ServiceLocator_NLcoaOgService', false],
            'App\\Controller\\DailyFridgeController::scan' => ['privates', '.service_locator.gPOL4mW', 'get_ServiceLocator_GPOL4mWService', false],
            'App\\Controller\\DailyFridgeController::updateHisto_consommer' => ['privates', '.service_locator.A9FiRqy', 'get_ServiceLocator_A9FiRqyService', false],
            'App\\Controller\\DailyFridgeController::updateHisto_perimer' => ['privates', '.service_locator.A9FiRqy', 'get_ServiceLocator_A9FiRqyService', false],
            'App\\Controller\\SecurityController::registration' => ['privates', '.service_locator.PjNDzse', 'get_ServiceLocator_PjNDzseService', false],
            'App\\Controller\\ContactController:index' => ['privates', '.service_locator.8ZuNAXa', 'get_ServiceLocator_8ZuNAXaService', false],
            'App\\Controller\\DailyFridgeController:accueil' => ['privates', '.service_locator.kS4J_tF', 'get_ServiceLocator_KS4JTFService', false],
            'App\\Controller\\DailyFridgeController:frigo' => ['privates', '.service_locator.z8PBJKF', 'get_ServiceLocator_Z8PBJKFService', false],
            'App\\Controller\\DailyFridgeController:frigo_detail' => ['privates', '.service_locator.cPhdqWx', 'get_ServiceLocator_CPhdqWxService', false],
            ...
            'App\\Controller\\DailyFridgeController::accueil' => '?',
            'App\\Controller\\DailyFridgeController::frigo' => '?',
            'App\\Controller\\DailyFridgeController::frigo_detail' => '?',
            'App\\Controller\\DailyFridgeController::index' => '?',
            'App\\Controller\\DailyFridgeController::liste_produit' => '?',
            'App\\Controller\\DailyFridgeController::mes_produits_perimes' => '?',
            'App\\Controller\\DailyFridgeController::scan' => '?',
            'App\\Controller\\DailyFridgeController::updateHisto_consommer' => '?',
            'App\\Controller\\DailyFridgeController::updateHisto_perimer' => '?',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('m2lsxzXqqM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getCache_PropertyAccessService()
    {
        ...
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('SKKpybOchd', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('U6oO6C8YHY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8FDnvTzcWR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('r2BqRtLrAe', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hZw7Qk7Qxf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lNS16kABZn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getConsole_Command_FormDebugService()
    {
        ...
        $this->privates['console.command.form_debug'] = $instance = new \Symfony\Component\Form\Command\DebugCommand(($this->privates['form.registry'] ?? $this->getForm_RegistryService()), [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type', 1 => 'App\\Form', 2 => 'Symfony\\Bridge\\Doctrine\\Form\\Type', 3 => 'Liip\\ImagineBundle\\Form\\Type'], [0 => 'App\\Form\\ContactType', 1 => 'App\\Form\\ProduitType', 2 => 'App\\Form\\RegistrationType', 3 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType', 4 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType', 5 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType', 6 => 'Symfony\\Bridge\\Doctrine\\Form\\Type\\EntityType', 7 => 'Liip\\ImagineBundle\\Form\\Type\\ImageType'], [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\TransformationFailureExtension', 1 => 'Symfony\\Component\\Form\\Extension\\HttpFoundation\\Type\\FormTypeHttpFoundationExtension', 2 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\FormTypeValidatorExtension', 3 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\RepeatedTypeValidatorExtension', 4 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\SubmitTypeValidatorExtension', 5 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\UploadValidatorExtension', 6 => 'Symfony\\Component\\Form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension', 7 => 'Symfony\\Component\\Form\\Extension\\DataCollector\\Type\\DataCollectorTypeExtension'], [0 => 'Symfony\\Component\\Form\\Extension\\Validator\\ValidatorTypeGuesser', 1 => 'Symfony\\Bridge\\Doctrine\\Form\\DoctrineOrmTypeGuesser'], ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()));
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $c = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $b, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($b, 'daily_fridge_accueil'), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'security_logout']);
